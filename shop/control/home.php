	...
	private function profile_menu($menu_type,$menu_key='') {
		...
		switch ($menu_type) {
			case 'member':
				...
				//3=>array('menu_key'=>'avatar',	'menu_name'=>Language::get('home_member_modify_mystore'),'menu_url'=>'index.php?act=home&op=avatar'),				
				4=>array('menu_key'=>'more',	'menu_name'=>Language::get('nc_member_path_predepositrecharge'),'menu_url'=>'index.php?act=predeposit'),
				5=>array('menu_key'=>'email',	'menu_name'=>Language::get('nc_member_path_predepositlog'),'menu_url'=>'index.php?act=predeposit&op=pd_log_list'),
