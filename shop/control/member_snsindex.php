...
/*		//查询谁来看过我
	...
	public function sharegoodsOp(){
		if ($_POST['form_submit'] == 'ok'){
			...
			$goods_info = $goods_model->getGoodsOnlineInfo($condition,'goods_id,goods_name,goods_image,goods_price,goods_freight,goods_collect,store_id');
			if (empty($goods_info)){
	...
	public function editlikeOp(){
		...
		$goods_info = $goods_model->getGoodsOnlineInfo($condition,'goods_id,goods_name,goods_image,goods_price,goods_freight,goods_collect');
		if (empty($goods_info)){
