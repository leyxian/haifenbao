    ...
    <tbody>
      ...
      <tr>
        <td class="tr" colspan="20"><div class="ncc-store-account">
            ...
            <dl class="operation" style="display:none">
              <dt>操作费：</dt>
              <dd>￥<em id="eachStoreOperation_<?php echo $store_id;?>">10.00</em></dd>
            </dl>
            <dl>
              <dt>商品金额：</dt>
     ...
     <tr>
        <td class="pd-account" colspan="20"><div class="ncc-pd-account">
            <div class="mt5 mb5"><label><input type="checkbox" class="vm mr5" value="1" name="pd_pay">使用预存款支付（当前可用余额：<em>￥<?php echo $output['available_pd_amount'];?></em>）</label></div>
