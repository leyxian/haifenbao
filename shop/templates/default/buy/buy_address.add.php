...
<div class="ncc-form-default">
  <form method="POST" id="addr_form" action="index.php">
    ...
    <dl>
        ...
        <dd>
            <input type="text" class="text w200" name="card" id="card" value="" palceholder="请输入身份证号码"/>
        </dd>
    </dl>
    <dl>
    ...
    <dl>
      ...
      <dd>
        <input type="text" class="text w200" name="address" id="address" maxlength="80" value=""/>
