...
<ul class="tab pngFix">
		<li class="active"><a  href="index.php?act=member_order"><?php echo $lang['nc_member_path_all_order'] ?></a></li>	
		<li class="normal"><a  href="index.php?act=member_order&state_type=state_new"><?php echo $lang['nc_member_path_wait_pay'] ?></a></li>
		<li class="normal"><a  href="index.php?act=member_order&state_type=state_noeval"><?php echo $lang['nc_member_path_wait_valuate'] ?></a></li>		
		<li class="normal"><a  href="index.php?act=member_order&state_type=state_cancel"><?php echo $lang['nc_member_path_canceled'] ?></a></li>		
		<li class="normal"><a  href="index.php?act=member_refund">						<?php echo $lang['nc_member_path_buyer_refund'] ?></a></li>	
		<li class="normal"><a  href="index.php?act=member_return">						<?php echo $lang['nc_member_path_buyer_return'] ?></a></li>	
	</ul>	
  </div>
    ...
    <table class="search-form">
      ...
      <tr>
        ...
        <td class="w100"><select name="state_type">
            ...
            <option value="state_new" <?php echo $_GET['state_type']=='state_new'?'selected':''; ?>><?php echo $lang['nc_member_path_wait_pay'];?></option>
