...
<div class="wrap">
  <div class="tabmenu">
	<ul class="tab pngFix">
		...
		<li class="active"><a  href="index.php?act=member_sell_order&state_type=state_cancel"><?php echo $lang['nc_member_path_canceled'] ?></a></li>	
  ...
  <form method="get" action="index.php" target="_self">
    <table class="search-form">
      ...
      <tr>
        ...
        <td class="w160"><input type="text" class="text" name="sell_order_sn" value="<?php echo $_GET['sell_order_sn']; ?>"></td>
  ...
  <table class="order ncu-table-style">
    <?php if ($output['order_group_list']) { ?>
      ...
      <?php }?>
      <?php if (!empty($group_info['buyer_pd_amount']) && $p == 0) {?><tr><td colspan="19" class="sep-row"></td></tr>
