...
<div class="tabmenu">
	<ul class="tab pngFix">
		<li class="active"><a  href="index.php?act=member_sell_order"><?php echo $lang['nc_member_path_all_order'] ?></a></li>	
...
<tr>
      ...
      <tr>
        ...
        <td><dl class="w100">
			...
			if(empty($order_info['extend_order_common']['goods_buyer_storage']) || $order_info['extend_order_common']['goods_buyer_storage']<$order_info['sell_goods_qty']){
			?>
			<a href="<?php echo urlShop('goods','index',array('goods_id'=>$goods_info['goods_id']));?>" target="_blank">库存不足，去采购</a>
			<?php }?>
			</dt>
        </dl></td>
        <td><dl class="w60">
