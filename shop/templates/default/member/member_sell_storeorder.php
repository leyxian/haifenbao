...
<ul class="tab pngFix">
		<li class="active"><a  href="index.php?act=member_order&state_type=state_pay">我的库存</a></li>	
		<li class="normal"><a  href="index.php?act=member_sell_order&op=store&state_type=sold_order">已经售完</a></li>
    ...
    <table class="search-form">
      ...
      <tr>
        ...
        <td class="w100"><select name="state_type">
          <option value="state_pay" <?php echo $_GET['state_type']=='state_pay'?'selected':''; ?>>现有库存</option>
        </select></td>
  ...
  <table class="order ncu-table-style">
    <?php if ($output['order_group_list']) { ?>
      ...
      <tr>
        ...
        <td>
        <dl class="goods-name">
            <dt><a href="<?php echo urlShop('goods','index',array('goods_id'=>$goods_info['goods_id']));?>" target="_blank"><?php echo $goods_info['goods_name']; ?></a>
			 <?php echo $goods_info['goods_serial'];?></dt>
            <dd>           
            </dd>
