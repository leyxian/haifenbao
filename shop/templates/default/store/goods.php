...
<link href="<?php echo RESOURCE_SITE_URL;?>/js/dialog/dialog.css" rel="stylesheet" type="text/css">
    ...
    <div class="ncs-goods-summary">
      ...
      <div class="ncs-key"> 
        ...
        <div class="ncs-btn"><!-- S 提示已选规格及库存不足无法购买 -->
          ...
          <!-- 加入缺货登记-->
		  <?php if ($output['goods']['goods_storage'] <= 0) {?>
      <!--    <a href="javascript:void(0);" nctype="shortStock_now_submit" class="buynow" title="<?php //echo $lang['nc_member_shortStock_manage'];?>">-->		  
       <a href="javascript:void(0)" title="<?php echo $lang['nc_member_shortStock_manage'];?>" class="buynow" uri="index.php?act=goods&op=add_shortStock&goods_id=<?php echo $output['goods']['goods_id']; ?>" dialog_width="560" dialog_title="<?php echo $lang['nc_member_shortStock_manage'];?>" nc_type="dialog"  dialog_id="seller_order_adjust_fee" id="order<?php echo $output['goods']['goods_id']; ?>_action_adjust_fee" /><i class="icon-pencil"></i><?php echo $lang['nc_member_shortStock_manage'];?></a> 	
		  <?php }?>	
		   <!-- 缺货登记-->
...
$(function(){
    ...
    // 加入缺货登记
//	$('a[nctype="shortStock_now_submit"]').click(function(){
//		 addshortStock(<?php echo $output['goods']['goods_id'];?>, checkQuantity());
//    });
    //浮动导航  waypoints.js
