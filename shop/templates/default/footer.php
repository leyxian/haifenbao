...
<div id="footer" class="wrapper">
        <p class="text-center c9" style="background:#fff;margin-bottom:0;padding-bottom:6px;"><!--增值电信业务经营许可证： Copyright 2006 - 2014 --><a style="color:#999;" href="http://www.miitbeian.gov.cn/" target="_blank">沪ICP备123456789号</a> <span style="margin-left:5px;"><img src="<?php echo SHOP_SITE_URL.'/templates/default/images/payment/zhifubao.png'; ?>" title="支付宝"></span></p>
<!--  <p><a href="<?php //echo SHOP_SITE_URL;?>"><?php //echo $lang['nc_index'];?></a>
  ...
  Copyright 2015-2016 HeFei ZQ Networking Inc.,All rights reserved.<br />
  Powered by <?php //echo $GLOBALS['setting_config']['zqshop_version'];?> <?php //echo $GLOBALS['setting_config']['icp_number']; ?><br />
