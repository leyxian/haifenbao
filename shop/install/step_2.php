...
<div class="main">
  ...
  <input type="hidden" value="3" name="step">
    <div class="select-install">
      <label>
      <input type="radio" name="iCheck" value="full" id="radio-1" class="green-radio" >
      <h4>完全安装 ZQ-Shop【B2B2C】</h4>
      <h5>电商系统</h5>
      </label>
    </div>
    <div class="select-module" id="result" style="display:none;">
      ...
      <ul>
        <li class="cms">
          <input type="checkbox" name="cms" id="cms" value="1"  disabled="">
          <div class="ico"></div>
          <h4>商城</h4>
          <p>ZQ-Shop商城模块是一套功能完善的多用户商城系统，也是整套电商门户的核心程序...</p>
        </li>
        <li class="shop">
          <input type="checkbox" name="shop" id="shop" value="1" checked="checked" disabled="">
          <div class="ico"></div>
          <h4>CMS</h4>
          <p>ZQ-Shop CMS模块拥有文章、画报、专题发布等功能，自定义编辑模板,可在文章内容中关联商品...</p>
        </li>
        <li class="circle">
          <input type="checkbox" name="circle" value="1">
          <div class="ico"></div>
          <h4>圈子</h4>
          <p>ZQ-Shop圈子模块是会员交流互动的理想环境，增强站点人气。主题帖中可与商品关联，特色鲜明...</p>
        </li>
        <li class="microshop">
          <input type="checkbox" name="microshop" value="1" checked="checked">
          <div class="ico"></div>
          <h4>微商城</h4>
          <p>ZQ-Shop微商城模块以新颖的形式展示会员已购商品、实物秀图，提高商品浏览量，促进商城经营...</p>
        </li>
      </ul>
    </div>
