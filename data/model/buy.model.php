...
class buyModel {
    ...
    public function createOrder($input, $member_id, $member_name, $member_email) {
        ...
        if($recever_type == '10'){
            ...
            $recever_id = $address_info['id_number'];
        }else{
        ...
        foreach ($store_cart_list as $store_id => $goods_list) {
            ...
            //操作费
            $order['operation_fee'] = $recever_type==20 ? 0 : 10;
            $order['order_flow'] = $recever_type;

            $order['order_amount'] = $store_final_order_total[$store_id] + $order['operation_fee'];
            $order['shipping_fee'] = $store_freight_total[$store_id];
            $order['goods_amount'] = $order['order_amount'] - $order['shipping_fee'] - $order['operation_fee'];
            $order['order_from'] = 1;
            ...
            $order_common['reciver_id'] = $recever_id;
    ...
    public function buyStep2($post, $member_id, $member_name, $member_email) {
        ...
        $input['recever_type'] = $post['recever_type']; //货物流向
