$(function(){
    var memberHtml = '<a class="btn mr5" href="'+WapSiteUrl+'/tmpl/member/member.html?act=member">个人中心</a><a class="btn mr5" href="'+WapSiteUrl+'//tmpl/member/register.html">免费注册</a>';
    ...
    var tmpl = '<div class="footer">'
        ...
        +'<div class="footer-content">'
            ...
            +'</p>'
            +'<p class="copyright">'
                +'版权所有 2015-2016 © 合肥市中擎网络科技有限责任公司'
            +'</p>'
        +'</div>'
    +'</div>';
