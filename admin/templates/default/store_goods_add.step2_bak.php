...
<div class="item-publish">
  <form method="post" id="goods_form" action="<?php if ($output['edit_goods_sign']) { echo urlAdmin('goods','edit_save_goods');} else { echo urlAdmin('goods_add', 'save_goods');}?>">
	...
	<dl>
        ...
        <dd>
          <ul class="ncsc-form-radio-list">
            ...
            <li>
              <label>
                <input name="order_state" value="0" type="radio" <?php if (empty($output['goods']['goods_state']) || $output['goods']['goods_state'] == 0 || $output['goods']['goods_state'] == 10) {?>checked="checked"<?php }?> />
                下架 </label>
            </li>
          </ul>
        </dd>
