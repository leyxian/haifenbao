      ...
      <tfoot>
        ...
        <tr colspan="15" class="tfoot">
          ...
          <td colspan="16"><label for="checkallBottom"><?php echo $lang['nc_select_all']; ?></label>
            &nbsp;&nbsp;<a href="JavaScript:void(0);" class="btn" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){document.brandForm.submit();}else{return false;}"><span><?php echo $lang['nc_del'];?></span></a>
