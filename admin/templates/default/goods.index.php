  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
		...
		<li><a href="<?php echo urlShop('store_goods_add', 'index', array('type' => 'add'));?>"><span><?php echo $lang['nc_add_goods'];?></span></a></li>
		<li><a href="<?php echo urlShop('store_goods_online', 'index', array('type' => 'add'));?>"><span><?php echo $lang['nc_manage_goods'];?></span></a></li>		
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td><?php echo $lang['currency'].$v['goods_price'] * $output['storage_array'][$v['goods_commonid']]['sum'];?></td>
          ...
          <td class="align-center"><p><a href="<?php echo urlAdmin('goods', 'edit_goods', array('commonid' => $v['goods_commonid']));?>" ><?php echo $lang['nc_edit'];?></a></p>
            <p><a href="javascript:void(0);" onclick="goods_lockup(<?php echo $v['goods_commonid'];?>);">商品下架</a></p></td>
        </tr>
      ...
      <tfoot>
        <tr class="tfoot">
          ...
          <td colspan="16"><label for="checkallBottom"><?php echo $lang['nc_select_all']; ?></label>
            &nbsp;&nbsp;<a href="JavaScript:void(0);" class="btn" nctype="lockup_batch"><span>商品下架</span></a> <a href="JavaScript:void(0);" class="btn" nctype="del_batch"><span><?php echo $lang['nc_del'];?></span></a>
...
function goods_lockup(ids) {
    ...
    CUR_DIALOG = ajax_form('goods_lockup', '商品下架理由', _uri, 350);
}
</script> 
