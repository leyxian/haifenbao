...
<div class="page">
  ...
  <form id="doc_form" method="post">
	...
	<tr class="noborder">
       <td class="vatop rowform onoff"><label for="nav_new_open1" class="cb-enable <?php if($output['doc']['is_use'] == '1'){ ?>selected<?php } ?>" ><span><?php echo $lang['nc_yes'];?></span></label>
            <label for="nav_new_open0" class="cb-disable <?php if($output['doc']['is_use'] == '0'){ ?>selected<?php } ?>" ><span><?php echo $lang['nc_no'];?></span></label>
            <input id="nav_new_open1" name="is_use_open" <?php if($output['doc']['is_use'] == '1'){ ?>checked="checked"<?php } ?>  value="1" type="radio">
            <input id="nav_new_open0" name="is_use_open" <?php if($output['doc']['is_use'] == '0'){ ?>checked="checked"<?php } ?>  value="0" type="radio"></td>
          <td class="vatop tips"></td>
        </tr>
