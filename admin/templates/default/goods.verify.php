  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
		...
		<li><a href="<?php echo urlAdmin('goods', 'add', array('type' => 'add'));?>"><span><?php echo $lang['nc_add_goods'];?></span></a></li>	
		<li><a href="<?php echo urlShop('store_goods_online', 'index', array('type' => 'manage'));?>"><span><?php echo $lang['nc_manage_goods'];?></span></a></li>			
